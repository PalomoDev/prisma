...
import {getAllProducts, getFeaturedProducts, getGalleryProducts, getProducts} from "@/lib/actions/product.actions";
...
const ProductsPage = async () => {
    ...
    const categories = await getCategories(true); // true = только активные
