...
const CreateCategoryPage = async () => {
  ...
  const subcategories = await getSubcategoriesFull();
  const categories = await getCategoriesFull(false);
    ...
    <div className={"flex flex-col gap-4"}>
      <div className="my-2">
        <div className={"flex justify-between"}>
          ...
          <Button asChild className={"bg-amber-600 uppercase w-56"}>
            <Link href="/admin/products/category/create-brand">
              Create New Brand
            </Link>
          </Button>
        </div>
      ...
      <div className="my-2">
        <div className={"flex justify-between"}>
          ...
          <Button asChild className={"bg-amber-600 uppercase w-56"}>
            <Link href="/admin/products/category/create-category">
              Create New Category
            </Link>
          </Button>
        </div>
      ...
      <div className="my-2">
        <div className={"flex justify-between"}>
          ...
          <Button asChild className={"bg-amber-600 uppercase w-56"}>
            <Link href="/admin/products/category/create-sub-category">
