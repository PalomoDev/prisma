...
import {getCategoryById, getSubcategories} from "@/lib/actions/product.actions";
...
const UpdateCategoryPage = async (props: {
    ...
    return (
        <div className="">
            <p>
                Update category {categoryResponse.data?.name}
            </p>
            <UpdateCategoryForm category={categoryResponse.data!} subcategories={subcategoriesResponse.data || []}  />
        </div>
    );
}
