...
import {
    ...
    getBrandByIdResponseSchema, subcategoryWithRelationsSchema, getSubcategoryByIdResponseSchema
...
export type GetSubcategoriesByCategoryIdInput = z.infer<typeof getSubcategoriesByCategoryIdSchema>;
export type DeleteSubcategoryInput = z.infer<typeof deleteSubcategorySchema>;

export type SubcategoryWithRelations = z.infer<typeof subcategoryWithRelationsSchema>;
...
export type CreateCategorySubcategoryInput = z.infer<typeof createCategorySubcategorySchema>;
export type CreateMultipleCategorySubcategoryInput = z.infer<typeof createMultipleCategorySubcategorySchema>;
export type DeleteCategorySubcategoryInput = z.infer<typeof deleteCategorySubcategorySchema>;
...
import {
    ...
    productActionResponseSchema, getGalleryProductResponseSchema, productShortResponseSchema,
...
export type ProductSpecification = z.infer<typeof productSpecificationResponseSchema>;
export type ProductFeature = z.infer<typeof productFeatureResponseSchema>;
export type ProductSubcategory = z.infer<typeof productSubcategoryResponseSchema>;
...
export type ProductsGalleryResponse = z.infer<typeof getGalleryProductResponseSchema>;
...
type CreateCategorySpecification = z.infer<typeof createCategorySpecificationSchema>;
type CategorySpecification = z.infer<typeof categorySpecificationSchema>;
type CreateMultipleCategorySpecification = z.infer<typeof createMultipleCategorySpecificationSchema>;
type UpdateCategorySpecification = z.infer<typeof updateCategorySpecificationSchema>;
type DeleteCategorySpecification = z.infer<typeof deleteCategorySpecificationSchema>;
type GetSpecificationsByCategory = z.infer<typeof getSpecificationsByCategoryIdSchema>;

// Значения спецификаций товаров
type CreateProductSpecificationValue = z.infer<typeof createProductSpecificationValueSchema>;
type ProductSpecificationValue = z.infer<typeof productSpecificationValueSchema>;
type CreateMultipleProductSpecificationValue = z.infer<typeof createMultipleProductSpecificationValueSchema>;
type UpdateProductSpecificationValue = z.infer<typeof updateProductSpecificationValueSchema>;
type UpdateMultipleProductSpecificationValue = z.infer<typeof updateMultipleProductSpecificationValueSchema>;
type DeleteProductSpecificationValue = z.infer<typeof deleteProductSpecificationValueSchema>;
type GetProductSpecificationValues = z.infer<typeof getProductSpecificationValuesByProductIdSchema>;
...
type CategorySpecificationsResponse = z.infer<typeof categorySpecificationsResponseSchema>;
type SpecificationsByCategoryResponse = z.infer<typeof specificationsByCategoryResponseSchema>;
type ProductSpecificationValuesResponse = z.infer<typeof productSpecificationValuesResponseSchema>;
type GroupedProductSpecificationValuesResponse = z.infer<typeof groupedProductSpecificationValuesResponseSchema>;

// Фильтрация
type SpecificationFilter = z.infer<typeof specificationFilterSchema>;
type ProductSpecificationFilter = z.infer<typeof productSpecificationFilterSchema>;

// Утилиты
type ValidateSpecificationValue = z.infer<typeof validateSpecificationValueSchema>;
