...
/**
 * DEPRECATED: Используйте getCategoriesFull из lib/actions/new/category/get.actions.ts
...
/**
 * DEPRECATED: Используйте createCategory из lib/actions/new/category/manage.actions.ts
...
/**
 * DEPRECATED: Используйте deleteCategory из lib/actions/new/category/manage.actions.ts
 * Удаляет категорию
 */
...
/**
 * DEPRECATED: Используйте getCategoryById из lib/actions/new/category/manage.actions.ts
...
/**
 * DEPRECATED: Используйте updateCategory из lib/actions/new/category/manage.actions.ts
 * Обновляет категорию
 */
