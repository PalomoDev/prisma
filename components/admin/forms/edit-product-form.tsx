...
type EditFormData = z.infer<typeof insertProductSchema>;

interface EditProductFormProps {
    productId: string;
    initialData: any; // TODO: типизировать после интеграции
...
const EditProductForm = ({
    ...
    // Формируем дефолтные значения из данных продукта
    ...
    const onSubmit = async (values: EditFormData) => {
        console.log('🔄 Updating product values:', values);
    ...
    const handleAddSpecification = (specificationId: string, specificationData: any) => {
        ...
        <div className="mx-auto py-6">
            <div className="mb-6">
                ...
                <p className="text-muted-foreground">
                    Update details for: {initialData.name} ({initialData.sku})
                </p>
            </div>
