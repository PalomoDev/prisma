...
import { updateSubcategorySchema, CategorySchema } from '@/lib/validations/category.validation';
import { updateSubcategory } from "@/lib/actions/product.actions";
...
const UpdateSubcategoryForm = ({ subcategory, categories }: UpdateSubcategoryFormProps) => {
