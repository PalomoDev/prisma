...
import { deleteSpecification } from "@/lib/actions/new/specification/manage.actions";
import { SpecificationFull } from "@/lib/validations/new/specification.validation";
import Link from "next/link";
import Image from "next/image";

interface SpecificationsTableProps {
  specifications: SpecificationFull[];
}

const SpecificationsTable = ({ specifications }: SpecificationsTableProps) => {
  if (!specifications || specifications.length === 0) {
    return (
      <div className="text-center py-4">No se encontraron especificaciones</div>
    );
  }
