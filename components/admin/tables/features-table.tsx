...
import { deleteFeature } from "@/lib/actions/spec-features.actions";
import Link from "next/link";
import Image from "next/image";

interface FeaturesTableProps {
    features: any[]; // Или создайте правильный тип
}
                ...
                <TableBody>
                    {features.map((feature) => (
                        <TableRow key={feature.id}>
                            <TableCell className="border-r border-l text-center">{formatId(feature.id)}</TableCell>
                            <TableCell className="border-r text-center">{feature.name}</TableCell>
                            <TableCell className="border-r text-center">{feature.key}</TableCell>
                            <TableCell className="border-r text-center">{feature.icon || '–'}</TableCell>
                            ...
                            <TableCell className="border-r text-center">{feature.sortOrder}</TableCell>
                            <TableCell className="border-r text-center">
                                {feature.isActive ? (
