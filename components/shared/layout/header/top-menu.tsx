...
const AdaptiveNavigation = ({products}:TopMenuProps ) => {
            ...
            <nav className="">
                <div className="container mx-auto px-4">
                    <div className="flex items-end justify-between h-16">
                        ...
                        <CustomMegaMenu categories={products} actividades={[]}/>
            ...
            {isMenuOpen && (
                <div className="lg:hidden fixed inset-0 z-50">
                    ...
                    <div className="fixed top-0 left-0 right-0 bg-white shadow-lg">
                        ...
                        <div className="py-6">
                            {menuItems.map((item) => (
                                <div key={item.title} className="px-6 py-4 border-b border-gray-100">
